//
//  TopupPhoneViewController.swift
//  LinkIDApp
//
...
class TopupPhoneViewController: TabmanViewController {
    private let disposebag = DisposeBag()
    var navigator: Navigator!
    var viewModel: TopupPhoneViewModel!
    var tabBar: TMBar!


    class func create(with navigator: Navigator, viewModel: TopupPhoneViewModel) -> Self {
        let vc = UIStoryboard.topup.instantiateViewController(ofType: TopupPhoneViewController.self)
...
extension TopupPhoneViewController: PageboyViewControllerDataSource, TMBarDataSource {
